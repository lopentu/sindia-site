const en = {
  translation: {
    ...
    "Read More": "Read More",
    "@Graduate": "@ National Taiwan University, Graduate Institute of Linguistics",
  ...
  about: {
    ...
    missions: {
      "1": {
        title: "1. To weave a linguistic continuum that spans thousands of years",
      ...
      "2": {
        title: "2. To create tools that prepare the Sinographic world for an AI future",
        ...
        footer: "These tools transform historical evidence into navigable landscapes of meaning."
      },
      ...
      "3": {
        ...
        footer: "Our mission is to reveal how language becomes a medium through which civilization remembers."
      },
